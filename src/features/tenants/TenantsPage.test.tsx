...
const tenant: Tenant = {
  ...
  recording_retention_days:90,users_count:1,users:[{id:'user-1',tenant_id:'tenant-1',name:'ABC Administrator',email:'admin@abcfinance.test',status:'ACTIVE'}],
...
describe('Super Admin tenant management',()=>{
  ...
  it('loads real tenants and opens the onboarding form',async()=>{
    ...
    expect(await screen.findByText('admin@abcfinance.test')).toBeInTheDocument()
